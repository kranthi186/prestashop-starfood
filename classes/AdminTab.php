...
//			$className = 'AdminCatalog';
    ...
    public function displayListHeader($token = null)
    {
        ...
        $totalPages = ceil($this->_listTotal / Tools::getValue('pagination', (isset($this->context->cookie->{$this->table.'_pagination'}) ? $this->context->cookie->{$this->table.'_pagination'} : $this->_pagination[1])));
        if (!$totalPages) {
            $totalPages = 1;
        }
        ...
        echo '
					...
					<span style="float: right;">
						...
						<input type="submit" id="submitFilterButton_'.$this->table.'" data-list-id="'.$this->table.'"name="submitFilter" value="'.$this->l('Filter').'" class="button" />
					</span>
