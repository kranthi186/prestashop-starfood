<?php
/**
* The file is QRcode libs of module. Do not modify the file if you want to upgrade the module in future
* 
...
class QRCodeLib {
	...
	public function createImage($z=4,$j=0){$im=imagecreate($this->dim,$this->dim);//Initialize image
