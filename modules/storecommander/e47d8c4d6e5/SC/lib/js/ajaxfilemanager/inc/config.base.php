 ...
 **/
//###
//### PRESTASHOP & STORE COMMANDER
//###
	if (file_exists('../../../../../../../config/config.inc.php')) // SC installed as PS module
	{
	...
	}elseif(file_exists('../../../../../config/config.inc.php')){ // SC installed in PS admin dir
		require_once('../../../../../config/config.inc.php');
		require_once('../../../../../init.php');
		//check if folder exist
		if (!is_dir('../../../../../img/cms'))
		...
		die('Prestashop config files not found. Please contact Store Commander support.');
	}
//###
//### END
//###
...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	define('CONFIG_THICKBOX_MAX_WIDTH', 580);
