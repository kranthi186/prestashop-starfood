...
<div id="right">
    ...
    <div id="toolbar">
        ...
        <a href="kcact:select"><span><?php echo $this->label("Select") ?></span></a>
        <a href="kcact:settings"><span><?php echo $this->label("Settings") ?></span></a>
        <?php /*?><a href="kcact:maximize"><span><?php echo $this->label("Maximize") ?></span></a>*/ ?>
