...
_.initToolbar = function() {
    ...
    $('#toolbar a[href="kcact:select"]').click(function() {
    	var file = $("#files div.file.selected");
    	if(file!=undefined && file!=null && file!="" && file!=0 && file.length==1)
    		_.returnFile(file);
        return false;
    });
...
_.showFiles = function(callBack, selected) {
    ...
    setTimeout(function() {
        ...
        $.each(_.files, function(i, file) {
        	if(file.name!="index.php" && file.name!=".htaccess")
        	{
	            var f, icon,
