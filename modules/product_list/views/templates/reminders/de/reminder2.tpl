...
{/literal}
<h1>Zweite Zahlungserinnerung zur Rechnung {$invoiceNumber} vom {$invoiceDate}.</h1>

<p>
Sehr geehrte Damen und Herren,
</p>
<p>
auf unsere bisherige Zahlungserinnerung konnten wir leider keinen Zahlungseingang verbuchen. 
Deshalb möchten wir Sie mit diesem Schreiben erneut freundlich an eine noch ausstehende Rechnung erinnern:
</p>
