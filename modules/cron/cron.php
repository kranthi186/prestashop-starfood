...
if (!class_exists('cron', false)) {
	require_once(_PS_ROOT_DIR_.DIRECTORY_SEPARATOR.'modules'.DIRECTORY_SEPARATOR.'cron'.DIRECTORY_SEPARATOR.'modulesamdha.php');
	class cron extends modulesamdha
	{
		public $shortName = 'cron';
		public function __construct()
		{
			$this->name = 'cron';
			$this->tab = version_compare(_PS_VERSION_, '1.4.0.0', '<')?'Tools':'administration';
			$this->version = '1.4.0.0';
		...
		**/
		public function hookFooter($params)
		{
			if (Configuration::get('cron_method') == 'traffic' &&
				...
				return '<img src="'.$this->_path.'cron_traffic.php?time='.time().'" alt="" width="0" height="0" style="border:none;margin:0; padding:0"/>';
		}
