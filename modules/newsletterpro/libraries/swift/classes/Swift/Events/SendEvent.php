 ...
 * @author     Chris Corbyn
 */
class NewsletterPro_Swift_Events_SendEvent extends NewsletterPro_Swift_Events_EventObject
{
     ...
     *
     * @var NewsletterPro_Swift_Mime_Message
     */
    private $_message;
     ...
     */
    public function __construct(NewsletterPro_Swift_Transport $source, NewsletterPro_Swift_Mime_Message $message)
    {
     ...
     *
     * @return NewsletterPro_Swift_Mime_Message
     */
