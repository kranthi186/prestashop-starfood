 ...
 * @author     Chris Corbyn
 */
class NewsletterPro_Swift_Events_SimpleEventDispatcher implements NewsletterPro_Swift_Events_EventDispatcher
{
    ...
    public function __construct()
    {
        $this->_eventMap = array(
            'NewsletterPro_Swift_Events_CommandEvent' => 'NewsletterPro_Swift_Events_CommandListener',
            'NewsletterPro_Swift_Events_ResponseEvent' => 'NewsletterPro_Swift_Events_ResponseListener',
            'NewsletterPro_Swift_Events_SendEvent' => 'NewsletterPro_Swift_Events_SendListener',
            'NewsletterPro_Swift_Events_TransportChangeEvent' => 'NewsletterPro_Swift_Events_TransportChangeListener',
            'NewsletterPro_Swift_Events_TransportExceptionEvent' => 'NewsletterPro_Swift_Events_TransportExceptionListener',
            );
    }
    ...
    {
        return new NewsletterPro_Swift_Events_SendEvent($source, $message);
    }
    ...
    {
        return new NewsletterPro_Swift_Events_CommandEvent($source, $command, $successCodes);
    }
    ...
    {
        return new NewsletterPro_Swift_Events_ResponseEvent($source, $response, $valid);
    }
    ...
    {
        return new NewsletterPro_Swift_Events_TransportChangeEvent($source);
    }
    ...
    {
        return new NewsletterPro_Swift_Events_TransportExceptionEvent($source, $ex);
    }
    ...
    private function _prepareBubbleQueue(NewsletterPro_Swift_Events_EventObject $evt)
    {
    ...
    private function _bubble(NewsletterPro_Swift_Events_EventObject $evt, $target)
    {
