 ...
 */
class NewsletterPro_Swift_FileSpool extends NewsletterPro_Swift_ConfigurableSpool
{
    /** The spool directory */
    private $_path;
    ...
    public function __construct($path)
    {
        ...
        if (!file_exists($this->_path)) {
            if (!mkdir($this->_path, 0777, true)) {
                throw new NewsletterPro_Swift_IoException('Unable to create Path ['.$this->_path.']');
            }
        }
    }
    ...
    public function queueMessage(NewsletterPro_Swift_Mime_Message $message)
    {
        ...
        throw new NewsletterPro_Swift_IoException('Unable to create a file for enqueuing Message');
    }
