 ...
 * @author     Chris Corbyn
 */
class NewsletterPro_Swift_CharacterReaderFactory_SimpleCharacterReaderFactory implements NewsletterPro_Swift_CharacterReaderFactory
{
    /**
    ...
    public function init()
    {
        ...
        $prefix = 'NewsletterPro_Swift_CharacterReader_';
