 ...
 * @author     Chris Corbyn
 */
interface NewsletterPro_Swift_Mime_Message extends NewsletterPro_Swift_Mime_MimeEntity
{
    /**
     ...
     * addresses, but NewsletterPro_Swift itself does not require it directly.
     *
