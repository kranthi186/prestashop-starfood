 ...
 * @author     Chris Corbyn
 */
class NewsletterPro_Swift_Mime_MimePart extends NewsletterPro_Swift_Mime_SimpleMimeEntity
{
    ...
    protected function _convertString($string)
    {
        ...
        if (!in_array($charset, array('utf-8', 'iso-8859-1', ''))) {
            ...
            if (function_exists('mb_convert_encoding')) {
                ...
                throw new NewsletterPro_Swift_SwiftException('No suitable convert encoding function (use UTF-8 as your charset or install the mbstring or iconv extension).');
            }
