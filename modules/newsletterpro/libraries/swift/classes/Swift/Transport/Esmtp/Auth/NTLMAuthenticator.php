 ...
 */
class NewsletterPro_Swift_Transport_Esmtp_Auth_NTLMAuthenticator implements NewsletterPro_Swift_Transport_Esmtp_Authenticator
{
     ...
     */
    protected function sendMessage1(NewsletterPro_Swift_Transport_SmtpAgent $agent)
    {
     ...
     * @return string
     */
    protected function sendMessage3($response, $username, $password, $timestamp, $client, NewsletterPro_Swift_Transport_SmtpAgent $agent, $v2 = true)
    {
