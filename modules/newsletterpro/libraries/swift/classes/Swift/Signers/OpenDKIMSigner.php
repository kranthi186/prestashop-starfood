 ...
 */
class NewsletterPro_Swift_Signers_OpenDKIMSigner extends NewsletterPro_Swift_Signers_DKIMSigner
{
    ...
    public function __construct($privateKey, $domainName, $selector)
    {
        if (extension_loaded('opendkim')) {
            ...
            throw new NewsletterPro_Swift_SwiftException('php-opendkim extension not found');
        }
    ...
    {
        $header = new NewsletterPro_Swift_Mime_Headers_OpenDKIMHeader('DKIM-Signature');
        $headerVal = $this->_dkimHandler->getSignatureHeader();
        if (!$headerVal) {
            throw new NewsletterPro_Swift_SwiftException('OpenDKIM Error: '.$this->_dkimHandler->getError());
        }
    ...
    {
        // add the if statment for the prestashop validator
        return $this;
        ...
        //         throw new NewsletterPro_Swift_SwiftException('Unable to force signature timestamp ['.openssl_error_string().']');
        //     }
        // }
