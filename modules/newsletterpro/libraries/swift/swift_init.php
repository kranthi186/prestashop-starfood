...
/*
 * Dependency injection initialization for NewsletterPro_Swift Mailer.
 */

if (defined('NEWSLETTERPRO_SWIFT_INIT_LOADED')) {
    return;
}

define('NEWSLETTERPRO_SWIFT_INIT_LOADED', true);
