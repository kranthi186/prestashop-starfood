...
NewsletterPro_Swift_DependencyContainer::getInstance()
    ...
    ->asSharedInstanceOf('NewsletterPro_Swift_Mime_Grammar')

    ->register('mime.message')
    ->asNewInstanceOf('NewsletterPro_Swift_Mime_SimpleMessage')
    ...
    ->register('mime.part')
    ->asNewInstanceOf('NewsletterPro_Swift_Mime_MimePart')
    ->withDependencies(array(
        'mime.headerset',
        'mime.qpcontentencoder',
        'cache',
    ...
    ->asNewInstanceOf('NewsletterPro_Swift_Mime_Attachment')
    ->withDependencies(array(
        'mime.headerset',
    ...
    ->asNewInstanceOf('NewsletterPro_Swift_Mime_EmbeddedFile')
    ->withDependencies(array(
        'mime.headerset',
        'mime.base64contentencoder',
        'cache',
    ...
    ->asNewInstanceOf('NewsletterPro_Swift_Mime_SimpleHeaderFactory')
    ->withDependencies(array(
    ...
    ->asNewInstanceOf('NewsletterPro_Swift_Mime_SimpleHeaderSet')
    ->withDependencies(array('mime.headerfactory', 'properties.charset'))

    ->register('mime.qpheaderencoder')
    ->asNewInstanceOf('NewsletterPro_Swift_Mime_HeaderEncoder_QpHeaderEncoder')
    ->withDependencies(array('mime.charstream'))

    ->register('mime.base64headerencoder')
    ->asNewInstanceOf('NewsletterPro_Swift_Mime_HeaderEncoder_Base64HeaderEncoder')
    ->withDependencies(array('mime.charstream'))

    ->register('mime.charstream')
    ->asNewInstanceOf('NewsletterPro_Swift_CharacterStream_NgCharacterStream')
    ->withDependencies(array('mime.characterreaderfactory', 'properties.charset'))

    ->register('mime.bytecanonicalizer')
    ->asSharedInstanceOf('NewsletterPro_Swift_StreamFilters_ByteArrayReplacementFilter')
    ...
    ->asSharedInstanceOf('NewsletterPro_Swift_CharacterReaderFactory_SimpleCharacterReaderFactory')
    ...
    ->asNewInstanceOf('NewsletterPro_Swift_Mime_ContentEncoder_RawContentEncoder')

    ->register('mime.nativeqpcontentencoder')
    ->withDependencies(array('properties.charset'))
    ->asNewInstanceOf('NewsletterPro_Swift_Mime_ContentEncoder_NativeQpContentEncoder')

    ->register('mime.qpcontentencoderproxy')
    ->asNewInstanceOf('NewsletterPro_Swift_Mime_ContentEncoder_QpContentEncoderProxy')
    ...
    ->asNewInstanceOf('NewsletterPro_Swift_Mime_ContentEncoder_PlainContentEncoder')
    ...
    ->asSharedInstanceOf('NewsletterPro_Swift_Mime_ContentEncoder_Base64ContentEncoder')

    ->register('mime.rfc2231encoder')
    ->asNewInstanceOf('NewsletterPro_Swift_Encoder_Rfc2231Encoder')
    ->withDependencies(array('mime.charstream'))
