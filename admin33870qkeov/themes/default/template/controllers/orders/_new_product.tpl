...
*}
<tr id="new_product_search_block">
	<td colspan="3" id="new_product_search_block_categories">
		<div id="new_product_search_block_categories_block">
			{l s='Categories'}
	...
	<td colspan="10" id="new_product_search_block_products">
...
<td></td><td></td>
	...
	{*<td style="display:none;" colspan="2">
		<select class="form-control" name="add_product[invoice]" id="add_product_product_invoice" disabled="disabled" autocomplete="off" >
                    <option value="0">{l s='Don\'t create new invoice'}</option>
                    <option value="1">{l s='Create a new invoice'}</option>
		</select>
	</td>*}
