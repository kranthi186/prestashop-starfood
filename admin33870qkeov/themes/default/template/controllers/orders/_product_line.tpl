...
<tr class="product-line-row">
    <td><input class="productIdCheckBox" type="checkbox" name="productId[]" value="{$product['id_order_detail']}" data-ref="{$product.product_supplier_reference}"></td>
	...
	<td>
        ...
        <td>
            <a href="#" class="inStockChangeLink list-action-enable {if $product.in_stock}action-enabled{else}action-disabled{/if}">{if $product.in_stock}<i class="icon-check"></i>{else}<i class="icon-remove"></i>{/if}</a>
        </td>
        <td>
            {if !empty($product.who_shipped)}
            <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="{$product.who_shipped}" data-html="true" data-placement="top">
            {/if}
            <a href="#" class="shippedChangeLink list-action-enable {if $product.shipped}action-enabled{else}action-disabled{/if}">{if $product.shipped}<i class="icon-check"></i>{else}<i class="icon-remove"></i>{/if}</a>
            {if !empty($product.who_shipped)}
            </span>
            {/if}
        </td>
	...
	{/if}
	{if $stock_management}<td class="productQuantity product_stock text-center" rel="" data-id="{$product.product_supplier_reference}">{$product['current_stock']}</td>{/if}
