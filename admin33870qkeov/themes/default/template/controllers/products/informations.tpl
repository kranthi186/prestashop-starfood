...
<div id="product-informations" class="panel product-tab">
	...
	<div class="form-group">
		...
		<div class="col-lg-3">
			<input maxlength="32" type="text" id="upc" name="upc" value="{$product->upc|escape:'html':'UTF-8'}" />
		</div>
	</div>

	<div class="form-group">
		<label class="control-label col-lg-3" for="box_code">
			{l s='Box code'}
		</label>
		<div class="col-lg-4">
			<input name="box_code" id="box_code" type="text" value="{$product->box_code}" />
		</div>
	</div>
	...
	<div id="product_options" class="form-group">
		<div class="col-lg-12">
			...
			<input name="condition" value="new" type="hidden">
			{*
			<div class="form-group">
