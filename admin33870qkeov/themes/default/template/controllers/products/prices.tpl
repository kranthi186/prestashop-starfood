...
<div id="product-prices" class="panel product-tab">
	...
	<div class="form-group">
		<label class="control-label col-lg-3" for="supply_price">
			{l s='Supply price'}
		</label>
		<div class="col-lg-4">
	...
	<div class="form-group">
		<label class="control-label col-lg-3" for="supply_currency">
			{l s='Supply currency'}
		</label>
		<div class="col-lg-4">
	...
	<div class="form-group">
		<label class="control-label col-lg-3" for="customs_tax">
			{l s='Customs tax'}
		</label>
		<div class="col-lg-4">
	...
	<div class="form-group">
		<label class="control-label col-lg-3" for="supply_cost">
			{l s='Supply cost'}
		</label>
		<div class="col-lg-4">
	...
	<div class="form-group">
		...
		<label class="control-label col-lg-3" for="profit_margin">
			{l s='Profit margin'}
		</label>
		<div class="col-lg-4">
			<input type="text" id="profit_margin" name="profit_margin" value="{$product->profit_margin|htmlentitiesUTF8}" />
		</div>
	</div>
	*}
	<div class="form-group">
		<label class="control-label col-lg-3" for="margin_retail">
			{l s='Retail margin, %'}
		</label>
		<div class="col-lg-4">
			<input type="text" id="margin_retail" name="margin_retail" value="{$product->margin_retail|htmlentitiesUTF8}" />
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-lg-4">
			<div class="input-group">
				...
				<input type="text" id="margin_bulk_1" name="margin_bulk_1" value="{$product->margin_bulk_1|htmlentitiesUTF8}" />
				<span class="input-group-addon">{l s='per'}</span>
				<input type="text" id="quantity_bulk_1" name="quantity_bulk_1" value="{$product->quantity_bulk_1|htmlentitiesUTF8}" />
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-lg-4">
			<div class="input-group">
				<span class="input-group-addon">%</span>
				<input type="text" id="margin_bulk_2" name="margin_bulk_2" value="{$product->margin_bulk_2|htmlentitiesUTF8}" />
				<span class="input-group-addon">{l s='per'}</span>
				<input type="text" id="quantity_bulk_2" name="quantity_bulk_2" value="{$product->quantity_bulk_2|htmlentitiesUTF8}" />
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-lg-4">
			<div class="input-group">
				<span class="input-group-addon">%</span>
				<input type="text" id="margin_bulk_3" name="margin_bulk_3" value="{$product->margin_bulk_3|htmlentitiesUTF8}" />
				<span class="input-group-addon">{l s='per'}</span>
				<input type="text" id="quantity_bulk_3" name="quantity_bulk_3" value="{$product->quantity_bulk_3|htmlentitiesUTF8}" />
			</div>
		</div>
	</div>
