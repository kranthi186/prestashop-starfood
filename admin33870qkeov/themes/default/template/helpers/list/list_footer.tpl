			...
			<ul class="dropdown-menu">
				...
				{foreach $bulk_actions as $key => $params}
					<li{if $params.text == 'divider'} class="divider"{/if}>
						...
						<a href="#" onclick="{if isset($params.confirm)}if (confirm('{$params.confirm}')){/if}sendBulkAction($(this).closest('form').get(0), 'submitBulk{$key}{$table}', {if !empty($params.targetBlank)}'{$params.targetBlank|escape:'javascript'}'{else}0{/if});">
