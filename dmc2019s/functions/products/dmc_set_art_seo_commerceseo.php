...
*  Artikel SEOs anlegen	commerce:SEO										*
...
*/
					...
					if (DEBUGGER>=1) fwrite($dateihandle, "dmc_set_art_seo_commerceseo - ");
					$Artikel_SEO_Bezeichnung =  dmc_prepare_seo ($Artikel_ID."_".$Artikel_Bezeichnung,"product",$Kategorie_ID,'de');
					if (DEBUGGER>=1) fwrite($dateihandle, "SEO commerce:SEO -> $Artikel_SEO_Bezeichnung\n");
