...
<div id="newsletter_block_left" class="inline block">
    {if isset($msg) && $msg}
        <p class="{if $nw_error}warning_inline{else}success_inline{/if}">{$msg}</p>
    {/if}
        <h3 class="title_block"><span class="title">{l s='Get a newsletter' mod='blocknewsletter'}</span></h3>
        <p>{l s='Sign up to receive our hostest products. We never send spam' mod='blocknewsletter'}</p>
