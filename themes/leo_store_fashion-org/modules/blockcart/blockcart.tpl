...
<div class="blockcart_top clearfix{if $PS_CATALOG_MODE} header_user_catalog{/if} col-lg-2 col-md-3 col-sm-4 col-xs-12">
{/if}
		...
		<div class="media heading">
			<div class="cart-inner media-body">
				<a href="{$link->getPageLink($order_process, true)|escape:'html':'UTF-8'}" title="{l s='View my shopping cart' mod='blockcart'}" rel="nofollow">
					<span class="title-cart">{l s='Shopping Cart' mod='blockcart'}</span>
					...
					<span class="ajax_cart_product_empty ajax_cart_no_product{if $cart_qties > 0} unvisible{/if}">
						{l s='0 item(s)' mod='blockcart'}
					</span>
				...
				<div class="block_content">
					...
					<div class="cart_block_list{if isset($blockcart_top) && !$blockcart_top}{if isset($colapseExpandStatus) && $colapseExpandStatus eq 'expanded' || !$ajax_allowed || !isset($colapseExpandStatus)} expanded{else} collapsed unvisible{/if}{/if}">
						...
						<p class="cart-buttons clearfix">
							<a id="button_order_cart" class="btn btn-outline btn-sm button-medium button button-small pull-right" href="{$link->getPageLink("$order_process", true)|escape:"html":"UTF-8"}" title="{l s='Check out' mod='blockcart'}" rel="nofollow">
								<span>
		...
		<div class="clearfix">
			...
			<div class="layer_cart_cart col-xs-12 col-md-6">
				...
				<div class="button-container">	
					<span class="continue btn btn-outline btn-sm button exclusive-medium" title="{l s='Continue shopping' mod='blockcart'}">
						<span>
							{l s='Continue shopping' mod='blockcart'}
						</span>
					</span>
					<a class="btn btn-outline btn-sm button pull-right" href="{$link->getPageLink("$order_process", true)|escape:"html":"UTF-8"}" title="{l s='Proceed to checkout' mod='blockcart'}" rel="nofollow">
						<span>
