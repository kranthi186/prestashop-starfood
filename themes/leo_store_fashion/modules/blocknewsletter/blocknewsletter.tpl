...
<div id="newsletter_block_left" class="block inline">
    <h4 class="title_block">
		{l s='Join our newsletter' mod='blocknewsletter'}
		<span>{l s='Enter your email to sign up' mod='blocknewsletter'}</span>
	</h4>
    <div class="block_content">
        <form action="{$link->getPageLink('index', null, null, null, false, null, true)|escape:'html':'UTF-8'}" method="post">
            <div class="form-group{if isset($msg) && $msg } {if $nw_error}form-error{else}form-ok{/if}{/if}">
                ...
                <input type="submit" value="{l s='subscribe' mod='blocknewsletter'}" class="button_mini btn btn-outline-inverse" name="submitNewsletter" />
