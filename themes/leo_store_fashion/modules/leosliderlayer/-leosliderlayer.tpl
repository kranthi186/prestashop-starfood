...
{/if}
    <div class="bannercontainer banner-{$sliderParams.slider_class}{if $sliderParams.group_class} {$sliderParams.group_class}{/if} col-lg-9 col-md-9 col-sm-12 col-xs-12" style="padding: {$sliderParams.padding};margin: {$sliderParams.margin};{$sliderParams.background}">
