...
{if $errors|@count == 0}
	...
	<meta itemprop="url" content="{$link->getProductLink($product)}">
		...
		{/if}
		<!-- left infos-->  
		<div class="pb-left-column col-xs-12 col-sm-12 col-lg-6 {if $content_only}col-md-6{else}col-md-8{/if}">
			<!-- product img-->        
		...
		<!-- end left infos--> 
		<!-- center infos -->
		<div class="pb-center-column col-xs-12 col-sm-12 col-lg-6 {if $content_only}col-md-6{else}col-md-12{/if}">
			...
			<h5 class="product_original_name leo-skin-fore-color">{$product_english_name|escape:'html':'UTF-8'}</h5>
			{/if}
		...
		<!-- end center infos-->
		<!-- pb-right-column-->
		<div class="pb-right-column col-xs-12 col-sm-12 col-lg-6 {if $content_only}col-md-6{else}col-md-12{/if}">
			...
			<form id="buy_block"{if $PS_CATALOG_MODE && !isset($groups) && $product->quantity > 0} class="hidden"{/if} action="{$link->getPageLink('cart')|escape:'html':'UTF-8'}" method="post">
				...
				<div class="box-info-product">
					...
					{if $pieces_per_carton_text}
					<p id="product_pcs_per_carton">{$pieces_per_carton_text}</p>
					{/if}
					...
					<div class="product_attributes clearfix">
						...
						<p id="quantity_wanted_p"{if (!$allow_oosp && $product->quantity <= 0) || !$product->available_for_order || $PS_CATALOG_MODE} style="display: none;"{/if}>
							...
							<input type="text" name="qty" id="quantity_wanted" class="text form-control" value="{if isset($quantityBackup)}{$quantityBackup|intval}{else}{if $product->minimal_quantity > 1}{$product->minimal_quantity}{else}{if $units_per_box}{$units_per_box}{else}1{/if}{/if}{/if}" />
