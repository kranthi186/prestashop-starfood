...
$(document).ready(function(){
	...
	$('.product_list_add_to_cart_form').on('click', 'button[type="button"]', function(){
		var form = $(this).parents('form');
		var quantityInput = form.find('input[name="qty"]');
		var quantityValue = parseInt( quantityInput.val() );
		if($(this).data('operation') == 'up'){
			var quantityNew = quantityValue + 1;
		}
		else{
			var quantityNew = quantityValue - 1;
		}
...
$(document).ready(function(){
 $('#leo-top-menu ul li a').click(function(e) {
