...
<div class="box">
    ...
    {else}
        ...
        <form action="{$link->getPageLink('identity', true)|escape:'html':'UTF-8'}" method="post" class="std form-horizontal col-sm-8">
            <fieldset>
                ...
                <div class="required form-group">
                    ...
                    <div class="col-sm-8">
                    <input class="is_required validate form-control" autocomplete="off" data-validate="isEmail" type="email" name="email" id="email" value="{$smarty.post.email}" />
					</div>
                </div>
