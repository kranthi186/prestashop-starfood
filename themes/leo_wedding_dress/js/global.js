...
$(document).ready(function(){
  ...
  $(document).on('mouseenter', '.product-container', function(){$(this).find('.productVariants').show();});
  $(document).on('mouseleave', '.product-container', function(){$(this).find('.productVariants, .spvCatOtherBigImage').hide();});
