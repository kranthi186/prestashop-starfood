...
{else}
    {capture name=searchText}{if isset($search_query) && $search_query}{$search_query|escape:'html':'UTF-8'}{elseif $search_tag}{$search_tag|escape:'html':'UTF-8'}{elseif $ref}{$ref|escape:'html':'UTF-8'}{/if}{/capture}
        <span class="lighter">
        {l s='Search for "%s", %d results found' sprintf=[$smarty.capture.searchText, $nbProducts]}  
        </span>
