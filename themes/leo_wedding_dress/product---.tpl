...
<div class="primary_block" itemscope itemtype="https://schema.org/Product">
	<meta itemprop="url" content="{$link->getProductLink($product)}">
		...
		<div class="pb-center-column col-xs-12 col-sm-12 col-md-5">
			...
			<h1 itemprop="name">{$product->name|escape:'html':'UTF-8'}<br /><sub>{l s='PS ID: '}{$product->id|escape:'html':'UTF-8'}</sub></h1>
		...
		<div class="pb-right-column col-xs-12 col-sm-12 col-md-5">
			...
			<form id="buy_block"{if $PS_CATALOG_MODE && !isset($groups) && $product->quantity > 0} class="hidden"{/if} action="{$link->getPageLink('cart')|escape:'html':'UTF-8'}" method="post">
                ...
                {l s='Preis:'} <a href="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" style="font-size:12px;">{l s='"Sichtbar als registrierter Händler"'}</a>
                </p>
				...
				<div class="box-info-product">
					...
					<div class="box-cart box-cart-bottom">
                        ...
                        <div {if (!$allow_oosp && $product->quantity <= 0) || !$product->available_for_order || (isset($restricted_country_mode) && $restricted_country_mode) || $PS_CATALOG_MODE} class="show"{else}class="unvisible" {/if}>
                            ...
                            <div style="display:none;" id="show_message">{l s='Sie müssen registrierter und freigeschalteter Kunde bei uns sein um Preise zu sehen und Bestellungen aufzugeben.'} <br /><a href="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}">{l s='Hier klicken um Händler zu werden.'}</a></div>
                        </div>
                    ...
                    <div class="clear box-attribute-infomation">
                                ...
                                {foreach from = $group.attributes key = id_attribute item=value}
                                    <td>
                                        {if $group.attributes_quantity.$id_attribute <= 0}
                                            <span class="available_status out_stock" title="{l s='Orange'}"></span>
                                        {elseif $group.attributes_quantity.$id_attribute <=2}
                                            <span class="available_status lower_stock" title="{l s='Yellow'}"></span>
                                        {elseif $group.attributes_quantity.$id_attribute > 2}
                                            <span class="available_status in_stock" title="{l s='Green'}"></span>
                                        {/if}
                                    </td>
                               {/foreach}
                            </tr>
                        ...
                        <table class="table table-responsive">
                            <tr><td ><span class="available_status in_stock"></span></td><td>{l s=' = In stock'}</td></tr>
                            <tr><td ><span class="available_status lower_stock"></span></td><td>{l s=' = Low on stock'}</td></tr>
                            <tr><td ><span class="available_status out_stock"></span></td><td>{l s=' = out of stock / no stock available'}</td></tr>
                        </table>
                    </div>
                    {/if}
