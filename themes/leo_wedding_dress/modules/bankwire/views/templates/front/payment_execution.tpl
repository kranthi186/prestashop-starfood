...
{else}
    <form action="{$link->getModuleLink('bankwire', 'validation', [], true)|escape:'html':'UTF-8'}" method="post">
        ...
        <p class="cart_navigation clearfix" id="cart_navigation">
        	<a 
            class="button-exclusive btn btn-outline pull-right" href="{$link->getPageLink('order', true, NULL, "step=3")|escape:'html':'UTF-8'}">
                {l s='Other payment methods' mod='bankwire'}
            </a>
            <button 
            class="button btn button-medium btn-outline pull-left" 
            type="submit">
