	...
	{if $PS_STOCK_MANAGEMENT}
		<td class="cart_avail">
                    {if $product.quantity_available <= 0}
                        <span class="label label-warning" title="{l s='The product will be produced immediately after receipt of your order and completed in about 2 months. As soon as the goods have been received, we will inform you about this. Only then is the payment due.'}">{l s='Out of stock'}</span>
                    {else}
                        <span class="label label-success" title="{l s='The product is in stock and available immediately.'}">{l s='In Stock'}</span>
                    {/if}
