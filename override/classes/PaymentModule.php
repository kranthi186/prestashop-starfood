            ...
            foreach ($order_detail_list as $key => $order_detail) {
                ...
                if (!$order_creation_failed && isset($order->id)) {
                    ...
                    foreach ($order->product_list as $product) {
                        ...
                        $productObject = new Product($product['id_product'], false, $order->id_lang);
                        
                        if($product['supplier_reference']){
                            $product['name'] = $product['supplier_reference'];
                        }else{
                            $product['name'] = $product['name'].(isset($product['attributes']) ? ' - '.$product['attributes'] : ''); 
                        }
                        ...
                        foreach($productFeatures as $productFeature){
                            $featureValue = new FeatureValueCore($productFeature['id_feature_value'], $order->id_lang);

                            if( $productFeature['id_feature'] == $countryFeatureId ){
                                $countryValue = $featureValue->value;
                            }
                        }

                        $piecesPerCartonText = $productObject->getPackageUnitInfo($order->id_lang);
                        ...
                        $product_var_tpl = array(
                            ...
                            'imgUrl' => $this->context->link->getImageLink($product['name'], $productCover['id_image'], 
                                    'cart_default'),
                            'pieces_per_carton_text' => $piecesPerCartonText,
